...
const Hero = () => {
    ...
    return (
        <div className="w-full relative h-200">
            <div className="absolute inset-0 z-10 w-full overflow-hidden flex flex-col items-center h-full">
            ...
            <div className="absolute inset-0 z-0 left-100 top-50 w-96 h-84">
            ...
            <div className="absolute z-20 w-full h-full flex flex-col gap-y-6 items-center justify-center text-center"> 
               <p className="text-white text-7xl font-extrabold tracking-tigther leading-20">Talk to Someone New. <span className="text-transparent block bg-clip-text bg-linear-to-r from-blue-300 via-blue-600 to-blue-300">Instantly</span></p> 
               <p className="text-white text-xl tracking-wide font-bold">The fastest way to meet someone you've never met before.</p>
